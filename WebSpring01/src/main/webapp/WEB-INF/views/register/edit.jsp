	...
	<form method="post" id="regForm" action="/myapp/editOk">
		<ul>
			...
			<li>
				...
				<input type="text" name="tel3" id="tel3" value="${vo.tel3}"/></li>
			<li>이메일</li><!-- 입력하는거만 한다. -->
			...
			<li>
				<script>
	               var hobby = ['운동','쇼핑','게임','웹툰','요리','독서','영화관람','IT'];
	               var hobbyStr ='${vo.hobbyStr}'.split("/");//이미 선택한 취미 <자바의 배열>
	               var tag="";
